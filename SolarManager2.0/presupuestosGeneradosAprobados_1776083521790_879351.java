/*
 * Generated by JasperReports - 13/04/26 14:32
 */
 ...
 *
 */
public class presupuestosGeneradosAprobados_1776083521790_879351 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.String)field_estado.getValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.Integer)field_total.getValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.String)field_estado.getValue()) + " (" + ((java.lang.String)field_porcentaje.getValue()) + ")"; //$JR_EXPR_ID=10$
                break;
            }
           default :
           {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.String)field_estado.getOldValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.Integer)field_total.getOldValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.String)field_estado.getOldValue()) + " (" + ((java.lang.String)field_porcentaje.getOldValue()) + ")"; //$JR_EXPR_ID=10$
                break;
            }
           default :
           {
